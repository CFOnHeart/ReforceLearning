...
def draw_plot(iter_uniform, iter_root, iter_square, graph_name='./graph/mountain_v0_compare.png'):
    fig = plt.figure()
...
if __name__ == "__main__":
    iter_uniform = run('model/mountaincar_v0_uniform_model', 
        max_episodes=3, max_iter=2000, encode_func=encode_value_uniform);
    iter_root = run('model/mountaincar_v0_root_model', 
        max_episodes=3, max_iter=2000, encode_func=encode_value_root);
    iter_square = run('model/mountaincar_v0_square_model', 
        max_episodes=3, max_iter=2000, encode_func=encode_value_square);
