...
env_name = 'Acrobot-v1'
model_name = "./model/acrobot_improved_dqn.h5"
train_graph_name = "./graph/acrobot_improved_train_dqn.png"
test_graph_name = "./graph/acrobot_improved_test_dqn.png"


def train(graph_name, max_episodes=500, max_iter=2000):
